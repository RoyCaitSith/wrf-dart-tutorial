...
set BASE_DIR         = /uufs/chpc.utah.edu/common/home/zpu-group16/cfeng/03_CPEX_DAWN/10_ensemble/work # set this appropriately #%%%#
...
set cycle_vars_b     =   ( U V PH T MU QVAPOR QCLOUD QRAIN QICE QSNOW QGRAUP QNICE QNRAIN \
                           U10 V10 T2 Q2 PSFC TSLB SMOIS TSK )
set increment_vars_a = ( U V PH T MU QVAPOR QCLOUD QRAIN QICE QSNOW QGRAUP QNICE QNRAIN U10 V10 T2 Q2 PSFC )
set increment_vars_b = ( U V PH T MU QVAPOR QCLOUD QRAIN QICE QSNOW QGRAUP QNICE QNRAIN U10 V10 T2 Q2 PSFC )

#  Diagnostic parameters
set OBS_VERIF_DAYS      = 7

#  Generic queuing system parameters
set SUPER_PLATFORM      = kingspeak
...
#
set COMPUTER_CHARGE_ACCOUNT = zpu-kp            # set this appropriately #%%%#
set EMAIL                   = ROY.FENG@utah.edu # set this appropriately #%%%#
...
if ( $SUPER_PLATFORM == 'cheyenne') then
   ...
   set FILTER_QUEUE       = regular
   set FILTER_TIME        = 3:00:00
   set ADVANCE_QUEUE      = regular
   set ADVANCE_TIME       = 3:00:00
   set NODES              = 3
   set NTASKS             = 48
   set ACCOUNT            = zpu-kp
   set PARTITION          = zpu-kp
   set JOBNAME            = TEST_DART
else
